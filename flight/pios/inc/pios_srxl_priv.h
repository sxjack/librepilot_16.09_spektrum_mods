...
#define SRXL_SPEKTRUM_A2_HEADER    0xa2 /* AR9020, non-standard checksum */
#define SRXL_SPEKTRUM_A5_HEADER    0xa5 /* AR7700 onwards, standard checksum */
...
#define SRXL_A5_CHANNEL_DATA_BYTES (1 + 14) /* extra header byte + 7 channels */
